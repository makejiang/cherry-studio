...
export const getOvmsModels = (providerModels?: Array<{ id: string; name: string }>): Array<{ label: string; value: string }> => {
...
export const createOvmsConfig = (models?: Array<{ label: string; value: string }>): ConfigItem[] => {
  ...
  return [
    ...
    },
    {
      type: 'select',
      key: 'size',
      title: 'paintings.image_size',
      tooltip: 'paintings.ovms.size_tip',
    ...
    },
    {
      ...
      title: 'paintings.ovms.num_inference_steps',
      tooltip: 'paintings.ovms.num_inference_steps_tip',
      min: 1,
      max: 100,
      initialValue: 4
    },
    {
      ...
      tooltip: 'paintings.ovms.seed_tip',
      initialValue: 0
    }
  ]
}
